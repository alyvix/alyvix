...
class MouseManager(MouseManagerBase):
    ...
    def load_module(self):
        ...
        self.ahk.ahkExec("CoordMode \"Mouse\", \"Screen\"")
    ...
    def click(self, x, y, button=1, n_clicks=1, click_delay=10):
        ...
        for cnt_click in range(n_clicks):
            ...
            if button == self.left_button:
                self.ahk.ahkExec("Click \"" + str(xs) + " " + str(ys) + "\"")

            elif button == self.right_button:
                self.ahk.ahkExec("Click \"right " + str(xs) + " " + str(ys) + "\"")
            elif button == self.middle_button:
                self.ahk.ahkExec("Click \"middle " + str(xs) + " " + str(ys) + "\"")
    ...
    def move(self, x, y):
        ...
        self.ahk.ahkExec("Click \"" + str(xs) + " " + str(ys+5) + " 0\"")
        time.sleep(0.25)
        self.ahk.ahkExec("Click \"" + str(xs) + " " + str(ys) + " 0\"")
    ...
    def scroll(self,x, y, steps, direction, scroll_delay):
        ...
        for step in range(0, steps, 1):
            if direction == self.wheel_down:
                self.ahk.ahkExec("Click \"WheelDown\"")
            elif direction == self.wheel_up:
                self.ahk.ahkExec("Click \"WheelUp\"")
            elif direction == self.wheel_left:
                self.ahk.ahkExec("Click \"WheelLeft\"")
            elif direction == self.wheel_right:
                self.ahk.ahkExec("Click \"WheelRight\"")
    ...
    def drag(self, x1, y1, x2, y2, button=1):
        ...
        if button == self.left_button:
            ...
            self.ahk.ahkExec("Click \"" + str(x1s) + " " + str(y1s) + " 0\"")
            time.sleep(0.5)

            self.ahk.ahkExec("Click \"down\"")
            time.sleep(0.5)

            self.ahk.ahkExec("Click \"" + str(x2s) + " " + str(y2s) + " 0\"")
            time.sleep(0.5)
            ...
            self.ahk.ahkExec("Click \"right down\"")
            time.sleep(0.5)

            self.ahk.ahkExec("Click \"" + str(x2s) + " " + str(y2s) + " 0\"")
            time.sleep(0.5)

            self.ahk.ahkExec("Click \"right up\"")
