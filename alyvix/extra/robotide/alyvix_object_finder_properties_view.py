...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(9, 10, 543, 276))
        ...
        self.widget.setGeometry(QtCore.QRect(149, 9, 381, 184))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.gridLayoutWidget = QtGui.QWidget(self.widget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 380, 177))
        ...
        self.gridLayout.addWidget(self.line_10, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.dontclickRadio, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.find_radio, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleclickRadio, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.wait_radio, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.clickRadio, 4, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.inserttext, 5, 0, 1, 4)
        self.listWidget = QtGui.QListWidget(self.tab_design)
        self.listWidget.setGeometry(QtCore.QRect(8, 9, 131, 201))
        self.listWidget.setSelectionMode(QtGui.QAbstractItemView.SingleSelection)
        self.listWidget.setObjectName(_fromUtf8("listWidget"))
        self.widget_2 = QtGui.QWidget(self.tab_design)
        self.widget_2.setGeometry(QtCore.QRect(150, 310, 381, 182))
        self.widget_2.setObjectName(_fromUtf8("widget_2"))
        self.gridLayoutWidget_2 = QtGui.QWidget(self.widget_2)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 380, 175))
        ...
        self.gridLayout_2.addWidget(self.clickRadio_2, 4, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.doubleclickRadio_2, 4, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.line_9, 3, 0, 1, 4)
        self.inserttext_2 = QtGui.QPlainTextEdit(self.gridLayoutWidget_2)
        self.inserttext_2.setObjectName(_fromUtf8("inserttext_2"))
        self.gridLayout_2.addWidget(self.inserttext_2, 5, 0, 1, 4)
        self.pushButtonSetMainObj = QtGui.QPushButton(self.tab_design)
        self.pushButtonSetMainObj.setGeometry(QtCore.QRect(13, 220, 118, 23))
        self.pushButtonSetMainObj.setObjectName(_fromUtf8("pushButtonSetMainObj"))
        self.pushButtonAddSubObj = QtGui.QPushButton(self.tab_design)
        self.pushButtonAddSubObj.setGeometry(QtCore.QRect(143, 220, 118, 23))
        self.pushButtonAddSubObj.setObjectName(_fromUtf8("pushButtonAddSubObj"))
        self.pushButtonEditObj = QtGui.QPushButton(self.tab_design)
        self.pushButtonEditObj.setGeometry(QtCore.QRect(274, 220, 118, 23))
        self.pushButtonEditObj.setObjectName(_fromUtf8("pushButtonEditObj"))
        self.pushButtonRemoveObj = QtGui.QPushButton(self.tab_design)
        self.pushButtonRemoveObj.setGeometry(QtCore.QRect(405, 220, 118, 23))
        ...
        self.spinBoxArgs.setGeometry(QtCore.QRect(68, 195, 60, 22))
        ...
        self.listWidgetBlocks.setGeometry(QtCore.QRect(448, 9, 81, 211))
        ...
        self.textEditCustomLines.setGeometry(QtCore.QRect(8, 9, 431, 166))
        ...
        self.pushButtonAddBlock.setGeometry(QtCore.QRect(260, 189, 71, 23))
        self.pushButtonAddBlock.setObjectName(_fromUtf8("pushButtonAddBlock"))
        self.spinBoxLine = QtGui.QSpinBox(self.tab_customlines)
        self.spinBoxLine.setGeometry(QtCore.QRect(130, 189, 121, 22))
        ...
        self.label_line.setGeometry(QtCore.QRect(60, 190, 61, 21))
        ...
        self.pushButtonRemoveBlock.setGeometry(QtCore.QRect(340, 189, 91, 23))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Object Finder", None))
