...
# Form implementation generated from reading ui file 'alyvix_code_view.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(10, 10, 131, 149))
        ...
        self.pushButtonTapKey = QtGui.QPushButton(self.verticalLayoutWidget_6)
        self.pushButtonTapKey.setObjectName(_fromUtf8("pushButtonTapKey"))
        self.verticalLayout_6.addWidget(self.pushButtonTapKey)
        self.pushButtonPressKey = QtGui.QPushButton(self.verticalLayoutWidget_6)
        self.pushButtonPressKey.setObjectName(_fromUtf8("pushButtonPressKey"))
        self.verticalLayout_6.addWidget(self.pushButtonPressKey)
        self.pushButtonReleaseKey = QtGui.QPushButton(self.verticalLayoutWidget_6)
        self.pushButtonReleaseKey.setObjectName(_fromUtf8("pushButtonReleaseKey"))
        self.verticalLayout_6.addWidget(self.pushButtonReleaseKey)
        self.pushButtonPressKeys = QtGui.QPushButton(self.verticalLayoutWidget_6)
        self.pushButtonPressKeys.setObjectName(_fromUtf8("pushButtonPressKeys"))
        self.verticalLayout_6.addWidget(self.pushButtonPressKeys)
        self.pushButtonTypeString = QtGui.QPushButton(self.verticalLayoutWidget_6)
        self.pushButtonTypeString.setObjectName(_fromUtf8("pushButtonTypeString"))
        self.verticalLayout_6.addWidget(self.pushButtonTypeString)
        self.tabWidget.addTab(self.tab_7, _fromUtf8(""))
        self.tab_8 = QtGui.QWidget()
        self.tab_8.setObjectName(_fromUtf8("tab_8"))
        self.verticalLayoutWidget_7 = QtGui.QWidget(self.tab_8)
        self.verticalLayoutWidget_7.setGeometry(QtCore.QRect(10, 10, 131, 210))
        ...
        self.pushButtonMousePress = QtGui.QPushButton(self.verticalLayoutWidget_7)
        self.pushButtonMousePress.setObjectName(_fromUtf8("pushButtonMousePress"))
        self.verticalLayout_7.addWidget(self.pushButtonMousePress)
        self.pushButtonMouseRelease = QtGui.QPushButton(self.verticalLayoutWidget_7)
        self.pushButtonMouseRelease.setObjectName(_fromUtf8("pushButtonMouseRelease"))
        self.verticalLayout_7.addWidget(self.pushButtonMouseRelease)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButtonTapKey.setText(_translate("Form", "Tap Key", None))
        self.pushButtonPressKey.setText(_translate("Form", "Press Key", None))
        self.pushButtonReleaseKey.setText(_translate("Form", "Release Key", None))
        self.pushButtonPressKeys.setText(_translate("Form", "Press Keys", None))
        self.pushButtonTypeString.setText(_translate("Form", "Type String", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("Form", "Keyboard", None))
        self.pushButtonMousePress.setText(_translate("Form", "Press", None))
        self.pushButtonMouseRelease.setText(_translate("Form", "Release", None))
