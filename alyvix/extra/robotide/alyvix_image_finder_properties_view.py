...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(9, 10, 566, 368))
        ...
        self.widget.setGeometry(QtCore.QRect(172, 9, 381, 328))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.gridLayoutWidget = QtGui.QWidget(self.widget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 0, 380, 322))
        ...
        self.gridLayout.addWidget(self.text_encrypted, 12, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.find_radio, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.add_quotes, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.wait_disapp_radio, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.wait_radio, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.dontclickRadio, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelClickDelay, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.inserttext, 11, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.pushButtonXYoffset, 8, 1, 2, 1)
        ...
        self.gridLayout.addWidget(self.clickdelay_spinbox, 9, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.clicknumber_spinbox, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.movemouseRadio, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelClickNumber, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.holdreleaseRadio, 10, 0, 1, 2)
        ...
        self.holdreleaseComboBox.addItem(_fromUtf8(""))
        self.holdreleaseComboBox.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.holdreleaseComboBox, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.holdreleaseSpinBox, 10, 3, 1, 1)
        self.listWidget = QtGui.QListWidget(self.tab_design)
        self.listWidget.setGeometry(QtCore.QRect(8, 9, 157, 322))
        ...
        self.widget_2.setGeometry(QtCore.QRect(172, 370, 381, 305))
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(19, 10, 497, 71))
        ...
        self.pushButtonCancel.setGeometry(QtCore.QRect(491, 390, 75, 23))
        self.pushButtonCancel.setObjectName(_fromUtf8("pushButtonCancel"))
        self.pushButtonOk = QtGui.QPushButton(Form)
        self.pushButtonOk.setGeometry(QtCore.QRect(408, 390, 75, 23))
