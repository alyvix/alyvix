...
#
# Created: Tue Aug  7 16:04:30 2018
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("../images/32x32/dialog-ok-3.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonOk.setIcon(icon4)
